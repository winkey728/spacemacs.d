...
(with-eval-after-load "lispy"
  (or (spacemacs/system-is-mac) (define-key lispy-mode-map (kbd "M-d") nil)) ;; do not override copy-line
  (define-key lispy-mode-map (kbd "M-n") nil) ;; do not override move-line-down
